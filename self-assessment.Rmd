...
Not yet: Many lines of code require comments. For example, the code for creating the mutated variable "moving_avg_nutrients" and the for loop for creating the separate graphs need to be properly commented.
