...
Check my moving average function in `R\moving_avg.R` or  `moving_avg()` [https://github.com/vedikaS-byte/Analytical-Workflows-Project-Practice/blob/main/R/moving_avg.R]
